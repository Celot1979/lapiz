...
class FirebaseService {
  ...
  Future<void> crearCategoria(String categoria) async {
    try {
      // Referencia a la colección de categorías
      var collectionRef = _firestore.collection('categorias');

      // Crear un nuevo documento para la categoría
      await collectionRef.add({'nombre': categoria});
      print('Categoría "$categoria" creada exitosamente.');
    } catch (e) {
